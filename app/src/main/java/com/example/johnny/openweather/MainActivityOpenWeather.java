package com.example.johnny.openweather;
...
public class MainActivityOpenWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_open_weather);
        ...
        String url = "http://localhost:8082/ejemplo1/clima";
                      ...
                      try {
                            ...
                            if (response.has("weather")) {
                                ...
                                if (weather.has("icon")) {
                                    ...
                                    int identifier = getResources().getIdentifier("imagen_" + icon, "drawable", getPackageName());
